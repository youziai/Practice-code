...
<%--											<td><input name="ids" type="checkbox"></td>--%>
<%--											<td>${roleList[3].id}</td>--%>
<%--											<td>${roleList[3].roleName}</td>--%>
<%--											<td>${roleList[3].roleDesc}</td>--%>
<%--											<td class="text-center">--%>
<%--												<a href="#" class="btn bg-olive btn-xs">删除</a>--%>
<%--											</td>--%>
<%--										</tr>--%>
<%--代码增加--%>
								<c:forEach begin="0" end="${roleList.size()-1}" var="i" step="1">
												<tr>
													<td><input name="ids" type="checkbox"></td>
													<td>${roleList[i].id}</td>
													<td>${roleList[i].roleName}</td>
													<td>${roleList[i].roleDesc}</td>
													<td class="text-center">
														<a href="#" onclick="delRole('${roleList[i].id}')" class="btn bg-olive btn-xs">删除</a>
													</td>
												</tr>
								</c:forEach>
								</tbody>
